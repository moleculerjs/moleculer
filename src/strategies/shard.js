...
class ShardStrategy extends BaseStrategy {
	...
	/*
	getHash(key) {
		if (_.isFunction(this.opts.hash)) {
			return this.opts.hash.call(this, key);
		} else if (this.opts.hash == "crc32") {
			return this.crc32(key, false);
		}
	}*/
	 ...
	 *
	 * Credit: https://gist.github.com/wqli78/1330293/6d85cc967f32cccfcbad94ae7d088a3dcfc14bd9
	 *
	 * @param {String} str
	 * @param {Boolean} hex
