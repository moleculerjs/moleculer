...
describe("Test Registry constructor", () => {
	...
	it("test properties", () => {
		...
		expect(registry.opts).toEqual({ "balancing": true, "circuitBreaker": {"enabled": false, "failureOnReject": true, "failureOnTimeout": true, "halfOpenTime": 10000, "maxFailures": 3}, "preferLocal": true, strategy: RoundRobinStrategy});
